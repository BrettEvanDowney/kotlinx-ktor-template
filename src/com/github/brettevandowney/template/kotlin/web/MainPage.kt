...
import com.github.brettevandowney.template.kotlin.web.pages.pages.DefaultHomePage
import com.github.brettevandowney.template.kotlin.web.theme.DefaultTheme
...
class MainPage(
    ...
    private val leftFooterIcons = arrayOf("github", "linkedin")
    ...
    override fun HTML.apply() {
        insert(template) {
            defaultHead {
                ...
                title { +"""Kotlin/kotlinx.html Template by Brett Downey""" }
                meta {
                    name = "description"
                    content = ""
                }
            ...
            header {
                ...
                item {
                    i("fas fa-home responsive-image-size header-image") {
                        attributes["onclick"] = "location.href = '/';"
                    }
                }

                item {
                    i("fas fa-download responsive-image-size header-image") {
            ...
            footer {
                ...
                for (x in leftFooterIcons.indices) {
                    item {
                        div(classes = "inner-footer-wrapper inner-footer-left") {
                            a {
                                href = "https://github.com/BrettEvanDowney/"
                                target = "_blank"
                                i("bd-${leftFooterIcons[x]} responsive-image-size") {
                                }
                            }
                        }
                    }
                ...
                rightFooterIcons.forEach { item ->
                    item {
                        div(classes = "inner-footer-wrapper inner-footer-right") {
                            i("bd-$item responsive-image-size") {
                            }
                        }
                    }
                }
