package com.github.brettevandowney.youtubedlhelper.kotlin.web.items

import com.github.brettevandowney.youtubedlhelper.kotlin.web.items.center.account.AccountPopup
import com.github.brettevandowney.youtubedlhelper.kotlin.web.items.center.account.login.AccountHelpPanel
import com.github.brettevandowney.youtubedlhelper.kotlin.web.items.center.account.login.AccountRegisterPanel
import com.github.brettevandowney.youtubedlhelper.kotlin.web.items.center.account.login.LoginPanel
import com.github.brettevandowney.youtubedlhelper.kotlin.web.items.header.SidePanelItems
                ...
                div(classes = "inner-header") {
                    ...
                    div("dropdown inner-head-wrapper") {
                        button(classes = "dropdown-button") {
                            i("fa fa-align-justify fa-3x header-image") {
                            }
                        }
                    ...
                    div("dropdown-right-element inner-head-wrapper") {
                        id = "settings-icon"
                        i("fa fa-cogs fa-3x header-image") {
                        }
                    }
                    ...
                    div("dropdown-right-element inner-head-wrapper") {
                        id = "account-icon"
                        i("fa fa-address-card fa-3x header-image") {
                        }
                    }
                }
            }
